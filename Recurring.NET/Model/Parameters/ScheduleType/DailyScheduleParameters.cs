...
namespace Recurring.NET.Model.Parameters.ScheduleType
{
	...
	{
		public DailyScheduleParameters(string scheduleName, int occursEveryDays, Time occurrenceTime, Date startDate, Date? endDate = null, Guid? scheduleId = null, bool isEnabled = true)
		{
		...
		public DailyScheduleParameters(string scheduleName, int occursEveryDays, SubdayParameters subdayParameters, Date startDate, Date? endDate = null, Guid? scheduleId = null, bool isEnabled = true)
		{
